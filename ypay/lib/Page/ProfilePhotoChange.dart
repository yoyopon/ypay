...
class _ProfilePhotoChangeState extends State<ProfilePhotoChange> {
  ...
  File _image;ImagePicker picker=ImagePicker();DBHelper db=DBHelper();
                    ...
                    final snackBar = SnackBar(
                      ...
                      content: Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                          InkWell(child: Text(AppLocalizations.of(context).translate("takepic"),style: styleWhite,),
                          onTap: (){takePhoto();},
                          ),
                          Divider(color: Colors.white,),
                          InkWell(child: Text(AppLocalizations.of(context).translate("choosepic"),style: styleWhite,),
                          onTap: (){choosePhoto();},
                          ),
                          Divider(color: Colors.white,),
                          InkWell(child: Text(AppLocalizations.of(context).translate("cancel"),style: styleWhite,),
